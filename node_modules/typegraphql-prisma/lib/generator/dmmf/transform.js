        ...
        return {
            ...
            fields: inputType.fields
                ...
                return {
                    ...
                    isOmitted: (_b = modelField === null || modelField === void 0 ? void 0 : modelField.isOmitted.input) !== null && _b !== void 0 ? _b : false,
                };
            }),
        };
    };
...
function getMappedActionName(actionName, typeName, options) {
    ...
    const hasNoPlural = typeName === (0, pluralize_1.default)(typeName);
    if (hasNoPlural) {
        return defaultMappedActionName;
    }
    switch (actionName) {
        ...
        case "findMany": {
            return (0, pluralize_1.default)((0, helpers_2.camelCase)(typeName));
        }
        default: {
            return defaultMappedActionName;
        }
