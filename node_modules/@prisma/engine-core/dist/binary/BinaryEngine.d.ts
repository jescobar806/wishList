...
export declare class BinaryEngine extends Engine {
     ...
     */
    constructor({ cwd, datamodelPath, prismaPath, generator, datasources, showColors, logLevel, logQueries, env, flags, clientVersion, previewFeatures, engineEndpoint, enableDebugLogs, allowTriggerPanic, dirname, useUds, activeProvider, }: EngineConfig);
    private setError;
