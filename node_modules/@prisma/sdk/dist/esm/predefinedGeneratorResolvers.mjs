...
Please try to install it by hand with ${chalk.bold.greenBright("npm install @prisma/client")} and rerun ${chalk.bold(getCommandWithExecutor("prisma generate"))} \u{1F64F}.`);
      }
      console.info(`
